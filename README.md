...
This repo presents some Notebook examples that use the 
[ProActive Jupyter Kernel](https://github.com/ow2-proactive/proactive-jupyter-kernel) or the 
[ProActive Python Client](https://github.com/ow2-proactive/proactive-python-client).

To facilitate the understanding of these notebooks, please find below the ProActive Jupyter Kernel documentation.
...
### 2.2 Using a configuration file:
...
#### 3.5 Adding job fork environment and/or selection script
...
#### 3.6 Adding pre and/or post scripts
...
#### 3.13 Export the workflow in dot format
...
#### 3.14 Import a workflow from a dot file
...
#### 3.15 Submit your job to the scheduler
...
#### 3.17 Export the workflow in XML format
...
### 4. Display and use ActiveEon Portals directly in Jupyter
